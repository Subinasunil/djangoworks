...
from ecstore import views
from productapi.views import ProductView,ProductDetailView,ProductModelView,ProductDetailsModelView,ProductViewsetView,ProductModelviewsetView,UserModelView,CartView
from rest_framework.routers import DefaultRouter
from rest_framework.authtoken.views import obtain_auth_token
from rest_framework_simplejwt.views import TokenObtainPairView,TokenRefreshView
router=DefaultRouter()
router.register("api/v3/products",ProductViewsetView,basename="products")
router.register("api/v4/products",ProductModelviewsetView,basename="mproduct")
router.register("accounts/signup",UserModelView,basename="users")
router.register("api/user/carts",CartView,basename="carts")

urlpatterns = [
    path('admin/', admin.site.urls),
    path('estore/products',views.Productview.as_view()),
    ...
    # path('api/v3/token',obtain_auth_token),
